...
useEffect(() => {
  ...
  return (
    <div className="flex w-[100vw] overflow-x-hidden flex-col">
      ...
      />
      <div className="text-white bg-[url('./images/heroBackground6.png')] bg-contain bg-no-repeat bg-center  sm:space-y-[30px] bg-[#000] px-[10vw] flex flex-col items-center justify-center pt-[20vh] min-h-[100vh]">
          <div className="w-[100vw]  text-center leading-[30px] sm:leading-[70px] h-[100%]">
