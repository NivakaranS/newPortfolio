        ...
        <div className="bg-[#000] h-[200vh] flex items-center justify-center w-screen ">
            ...
            <div className=" w-[80%] ">
                ...
                <div className=" portfolio4 mt-[20px] flex flex-row space-x-[20px] items-center justify-center">
                    <PortfolioCard text2="This project aims to build a Machine Learning model that predicts house prices based on various features such as location, number of bedrooms, square footage, and amenities. By analyzing historical real estate data, the model provides accurate prices estimates, helping buyers, sellers, real estate agents make data-driven solutions." text="House Price Prediction" onClick={onPortfolioCard1Click}/>
